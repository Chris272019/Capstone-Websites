...
// Query to get user details from the users table where id matches user_id in blood_collection and status is not 'Verified'
$query = "
    SELECT u.id AS user_id, u.firstname, u.middlename, u.surname 
    FROM users u
    INNER JOIN blood_collection bc ON u.id = bc.user_id
                ...
                <tbody>
                    <?php foreach ($users as $user) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="blood_collection_staff_dashboard.php?user_id=<?php echo urlencode($user['user_id']); ?>" class="user-id-button">
                                    View Details
                                </a>
                            </td>
                        </tr>
