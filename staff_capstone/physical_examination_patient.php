...
// Query to get user details from the users table where id matches user_id in physical_examination and status is not 'Verified'
$query = "
    SELECT u.id AS user_id, u.firstname, u.middlename, u.surname 
    FROM users u
    INNER JOIN physical_examination pe ON u.id = pe.user_id
                ...
                <tbody>
                    <?php foreach ($users as $user) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="physical_examination_staff_dashboard.php?user_id=<?php echo urlencode($user['user_id']); ?>" class="action-button">
                                View Details
                                </a>
                            </td>
                        </tr>
