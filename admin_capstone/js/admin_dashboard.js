...
document.getElementById('hospitalManagementLink').addEventListener('click', () => {
    showContent('hospitalManagementContent');
    // Add any additional hospital-specific initialization here
});
